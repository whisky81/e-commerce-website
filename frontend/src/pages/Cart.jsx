        ...
        <div className="text-center py-20 bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl border border-slate-200">
          <svg className="w-20 h-20 text-slate-300 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
              d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2 9m10-9l2 9m-9 0h18m-18 0a2 2 0 11-4 0 2 2 0 014 0zm12 0a2 2 0 11-4 0 2 2 0 014 0z" />
          </svg>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-slate-200">
              {cartData.map((productData, index) => (
                <div key={index} className="p-4 hover:bg-blue-50/30 transition-colors flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-3">
                      <div className="flex items-center border border-slate-300 rounded-lg">
                        <button onClick={() => updateQuantity(productData.id, productData.quantity - 1)}
                      ...
                      <button onClick={() => updateQuantity(productData.id, 0)}
